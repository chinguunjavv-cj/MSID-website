...
const mn = {
  ...
  events: {
    ...
    noDetails: "Дэлгэрэнгүй мэдээлэл хараахан нийтлэгдээгүй байна.",
    programme: "Хөтөлбөр",
    /* The announcement band on an event page: what a congress states about itself. */
    format: "Хэлбэр",
    ...
    /* The call-for-abstracts card on an event page. */
    callForAbstracts: "Илтгэлийн хураангуй хүлээн авах",
    callForAbstractsLead: "Эрдэм шинжилгээний хөтөлбөрт илтгэл ирүүлэх",
    submissionDeadline: "Хүлээн авах эцсийн хугацаа",
    /* House rule, not per-event data: every deadline on this site closes at the end of
       that day in Ulaanbaatar. Stated so a reader abroad is not left guessing. */
    deadlineTime: "23:59 цаг хүртэл",
    deadlineZone: "Улаанбаатарын цагаар (UTC+8)",
    submitAbstract: "Хураангуй илгээх",
    registrationDetails: "Бүртгэлийн мэдээлэл",
    callOpen: "Нээлттэй",
    callClosed: "Хаагдсан",
    gallery: "Гэрэл зураг",
    /* Same phrase the hero's slide controls already use. */
    show: "Зураг харуулах",
    enlarge: "Томруулах",
    close: "Хаах",
...
const en: Dictionary = {
  ...
  events: {
    ...
    noDetails: "Details for this event have not been published yet.",
    programme: "Programme",
    format: "Format",
    ...
    callForAbstractsLead: "Scientific programme submissions",
    submissionDeadline: "Submission deadline",
    deadlineTime: "By 23:59",
    deadlineZone: "Ulaanbaatar time (UTC+8)",
